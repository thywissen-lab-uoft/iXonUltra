...
% % % 190 G driving harder 04/01
% composite_data(end+1).Name = '190 G 04/01';
% composite_data(end).Runs = [
%     2024 04 01 05;
%     2024 04 01 06;
%     2024 04 01 07;
...
% % % 190 G 650ms pre mod time 04/04
% composite_data(end+1).Name = '190 G 04/04';
% composite_data(end).Runs = [
%     2024 04 04 06;
% %     2024 04 04 07;
%     2024 04 04 08;
...
% % 190 G preheat at 201G for 500 ms 04/05
% composite_data(end+1).Name = '190 G 04/05';
% composite_data(end).Runs =  [
%     2024 04 05 09;
%     2024 04 05 10;
%     2024 04 05 11;
...
% % 190 G preheat at 201G for 500 ms, 150 ms mod ramp time 04/10
% composite_data(end+1).Name = '190 G 04/10';
% composite_data(end).Runs =  [
%     2024 04 10 05;
%     2024 04 10 06;
%     2024 04 10 07;
...
% 200.8 G high field evap 50 ms mod ramp 06/11
% composite_data(end+1).Name = '200.8 G 06/11';
% composite_data(end).Runs =  [
%     2024 06 11 07;
%     2024 06 11 08;
%     2024 06 11 09;
...
%     2024 06 11 24;
%     ];
% 201.1 G high field evap 50 ms mod ramp 10/23
composite_data(end+1).Name = '201.1 G 10/23';
composite_data(end).Runs =  [
    2024 10 23 05;
    2024 10 23 06;
    2024 10 23 07;
...
composite_data(end+1).Name = '201.1 G 11/05';
composite_data(end).Runs= [ 
    2024 11 05 09;
    2024 11 05 10;
    2024 11 05 11;

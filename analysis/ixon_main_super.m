...
composite_data= struct;
composite_data.Runs = runs;
composite_data.Name = '2025_01_16 190G specta 66 mW 4.5 Er pulse';
...
composite_data= struct;
composite_data.Runs = runs;
composite_data.Name = '2025_01_23 201.1G specta 64 mW 4 Er pulse';
...
composite_data= struct;
composite_data.Runs = runs;
composite_data.Name = '2025_01_24 201.1G specta 66 mW 5 Er pulse';
...
composite_data= struct;
composite_data.Runs = runs;
composite_data.Name = '2025_01_25 201.1G specta 63.8 mW';
...
composite_data= struct;
composite_data.Runs = runs;
composite_data.Name = '2025_01_27 200 G specta 65 mW, 6 Er pulse';
%%
runs = [  
    2025 01 28 08;
    2025 01 28 09;
...
composite_data= struct;
composite_data.Runs = runs;
composite_data.Name = '2025_01_27 190 G specta 64.5 mW, 5.5 Er pulse';
%%
% runs = [  
%     2025 01 29 04;
%     2025 01 29 05;
...
composite_data.Name = '2025_01_30 201.1 G 55 Hz 64.5 mW, 3 Er pulse, vary vert disp';
...
composite_data.Runs = runs;
% composite_data.Name = '2025_01_29 201.1 G 55 Hz 63.7 mW, 1 Er pulse, vary vert disp';
composite_data.Name = '2025_01_30 201.1 G 55 Hz 64.5 mW, 3 Er pulse, vary vert disp, 0.6 V amp.';
...
composite_data.Runs = runs;
% composite_data.Name = '2025_01_29 201.1 G 55 Hz 63.7 mW, 1 Er pulse, vary vert disp';
composite_data.Name = '2025_02_08 200.65 G spectrum 64.7 mW, 4.5 Er pulse';

%% 
runs = [
%     2025 02 08 22 % under driving
%     2025 02 08 23 % under driving
    2025 02 08 25
    2025 02 08 26
    2025 02 08 27
    2025 02 08 28
...
composite_data.Runs = runs;
% composite_data.Name = '2025_01_29 201.1 G 55 Hz 63.7 mW, 1 Er pulse, vary vert disp';
composite_data.Name = '2025_02_08 200.9 G spectrum 64.7 mW, 4.5 Er pulse';
...
composite_data.Runs = runs;
% composite_data.Name = '2025_01_29 201.1 G 55 Hz 63.7 mW, 1 Er pulse, vary vert disp';
composite_data.Name = '2025_02_09 200.65 G spectrum 64.8 mW, 4.5 Er pulse';
...
runs = [
    ...
    2025 02 10 15
    2025 02 10 16
%     2025 02 10 17 % low response bad fit
    2025 02 10 18
    2025 02 10 19
    2025 02 10 20
    2025 02 10 21
...
composite_data.Runs = runs;
% composite_data.Name = '2025_01_29 201.1 G 55 Hz 63.7 mW, 1 Er pulse, vary vert disp';
composite_data.Name = '2025_02_10 200.65 G spectrum 64.7 mW, 3 Er pulse';
%% 
runs = [
    2025 02 10 25
    2025 02 11 01
...
composite_data = struct;
composite_data.Runs = runs;
composite_data.Name = '2025_04_03 3.5ER 195 G spectrum 54 mW, 1 Er pulse';
...
composite_data = struct;
composite_data.Runs = runs;
composite_data.Name = '2025_04_09 2.5 Er 200 G spectrum 53.6 mW, 2 Er pulse 74 Hz';
%%
runs = [
...
%%
runs = [
    2025 04 12 05 % good signal
    2025 04 12 06 % no signal
    2025 04 12 07 % no signal
    2025 04 12 08 % good signal
    2025 04 12 09 % good signal
    2025 04 12 10 % no signal
    2025 04 12 11 % questionable, small amplitude
    2025 04 12 12 % good signal
    2025 04 12 13 % good signal
    2025 04 12 14 % large drift, small amplitude
    2025 04 12 15 % no signal
    2025 04 12 16 % good signal, large amplitude
    2025 04 12 17 % good signal
    2025 04 12 18 % good signal
    2025 04 12 19 % good signal, small ish amplitude
    2025 04 12 20 % okay signal, small amplitude
    2025 04 13 02 % good signal
    ];
composite_data = struct;
composite_data.Runs = runs;
